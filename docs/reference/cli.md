...
```bash
python scripts/cli/train.py --config <config.yaml> [overrides...]
```
...
```bash
# Basic training
python scripts/cli/train.py --config configs/searchqa/default.yaml

# With overrides
python scripts/cli/train.py \
...
```bash
python scripts/cli/eval_only.py --config <config.yaml> --skill <skill.md>
```
...
python scripts/cli/eval_only.py \
  --config configs/searchqa/default.yaml \
