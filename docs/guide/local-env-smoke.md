...
```bash
python -m py_compile scripts/cli/train.py skillopt/envs/myenv/adapter.py
python scripts/cli/train.py --config configs/myenv/tiny_mock.yaml
python scripts/cli/train.py --config configs/myenv/tiny.yaml
```
