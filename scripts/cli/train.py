#!/usr/bin/env python3
"""PatchTree unified training entry point.

Usage
-----
    python scripts/cli/train.py --config configs/alfworld/default.yaml
...
Run ``python scripts/cli/train.py --help`` for a full list of options.
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="PatchTree training",
    ...
    p.add_argument("--type_guided_max_patch_records", type=int)
    ...
    p.add_argument("--type_guided_fallback_reconcile_min_children", type=int)
    p.add_argument("--type_guided_cache_dir", type=str)
    p.add_argument("--type_guided_patch_record_workers", type=int)
    p.add_argument("--type_guided_clustering", type=_BOOL)
    p.add_argument("--type_guided_cluster_target_size", type=int)
    p.add_argument("--type_guided_cluster_max_size", type=int)
    p.add_argument("--type_guided_tail_bank", type=_BOOL)
    p.add_argument("--type_guided_tail_min_support", type=int)
    p.add_argument("--type_guided_tail_max_records", type=int)
    p.add_argument("--type_guided_tail_max_leaf_groups", type=int)
    p.add_argument("--type_guided_tail_window_epochs", type=int)
    p.add_argument("--type_guided_tail_require_cross_step", type=_BOOL)
    p.add_argument("--type_guided_leaf_merge_workers", type=int)
    p.add_argument("--type_guided_mid_merge_workers", type=int)
...
_LEGACY_TO_STRUCTURED: dict[str, str] = {
    ...
    "type_guided_max_patch_records": "optimizer.type_guided_max_patch_records",
    ...
    "type_guided_cache_dir": "optimizer.type_guided_cache_dir",
    "type_guided_patch_record_workers": "optimizer.type_guided_patch_record_workers",
    "type_guided_clustering": "optimizer.type_guided_clustering",
    "type_guided_cluster_target_size": "optimizer.type_guided_cluster_target_size",
    "type_guided_cluster_max_size": "optimizer.type_guided_cluster_max_size",
    "type_guided_tail_bank": "optimizer.type_guided_tail_bank",
    "type_guided_tail_min_support": "optimizer.type_guided_tail_min_support",
    "type_guided_tail_max_records": "optimizer.type_guided_tail_max_records",
    "type_guided_tail_max_leaf_groups": "optimizer.type_guided_tail_max_leaf_groups",
    "type_guided_tail_window_epochs": "optimizer.type_guided_tail_window_epochs",
    "type_guided_tail_require_cross_step": "optimizer.type_guided_tail_require_cross_step",
    "type_guided_leaf_merge_workers": "optimizer.type_guided_leaf_merge_workers",
    "type_guided_mid_merge_workers": "optimizer.type_guided_mid_merge_workers",
...
def load_config(args: argparse.Namespace) -> dict:
    ...
    if not flat.get("out_root"):
        ...
        flat["out_root"] = os.path.join("outputs", f"patchtree_{env}_{model}_{ts}")
...
def main() -> None:
    ...
    print(f"\n{'='*60}")
    print(f"  PatchTree — Hierarchical Skill Patch Optimization")
    print(f"{'='*60}")
    ...
    from skillopt.engine.trainer import PatchTreeTrainer
    trainer = PatchTreeTrainer(cfg, adapter)
