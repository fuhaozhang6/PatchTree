...
# Launch SkillOpt-Tree LiveMathematicianBench training on Volcano Ark.
#
# Default role split:
#   target / student    = Doubao Seed 1.6 Flash   (doubao-seed-1-6-flash-250828)
#   optimizer / teacher = DeepSeek V4 Flash on Ark (deepseek-v4-flash-260425)
#
# Both roles hit the same Ark OpenAI-compatible endpoint with the same key.
...
OPTIMIZER_MODEL="${OPTIMIZER_MODEL:-deepseek-v4-flash-260425}"
