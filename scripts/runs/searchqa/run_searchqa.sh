...
#
# Usage:
#   bash scripts/runs/searchqa/run_searchqa.sh
#   bash scripts/runs/searchqa/run_searchqa.sh --num_epochs 2 --edit_budget 6
#   bash scripts/runs/searchqa/run_searchqa.sh --split_dir /path/to/searchqa_split
# ──────────────────────────────────────────────────────────────────────────────
set -euo pipefail
