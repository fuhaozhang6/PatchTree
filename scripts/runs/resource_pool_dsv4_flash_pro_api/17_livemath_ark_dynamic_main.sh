...
MAIN_CFG="${MAIN_CFG:-optimizer.type_guided_tree_builder=recursive optimizer.type_guided_max_tree_depth=4 optimizer.type_guided_merge_target_children=3 optimizer.type_guided_merge_max_children=4 optimizer.type_guided_top_mode=conservative_root optimizer.type_guided_fallback_enabled=true optimizer.type_guided_fallback_max_hops=-1 optimizer.type_guided_fallback_allow_leaf=true optimizer.type_guided_fallback_min_leaf_coverage=1 optimizer.type_guided_validation_budget=16 optimizer.type_guided_fallback_sel_env_num=12 optimizer.type_guided_fallback_reconcile=llm_fuse}"
...
run_livemath_ark_case "hierarchical_conservative_main" "${MAIN_EPOCHS}" initial "${MAIN_CFG}"
