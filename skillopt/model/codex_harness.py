...
def render_skill_md(
    ...
    *,
    ...
    description: str = "Dynamic PatchTree skill for the current benchmark task.",
    preamble: str = "",
) -> str:
...
def _exec_prompt(prompt: str, *, allow_file_edits: bool = False) -> str:
    ...
    return (
        ...
        "Do not call a Skill tool; the PatchTree guidance is a local markdown file. "
