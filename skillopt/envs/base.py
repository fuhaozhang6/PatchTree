"""PatchTree environment adapter — abstract rollout/evaluation interface.

To connect PatchTree to a new environment, implement a subclass of
:class:`EnvAdapter` with environment-specific rollout logic.
...
class EnvAdapter(ABC):
    """Abstract adapter for connecting PatchTree to an environment."""
