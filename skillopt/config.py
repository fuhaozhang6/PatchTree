"""PatchTree config loading engine — structured YAML with inheritance.
...
_FLATTEN_MAP: dict[str, str] = {
    ...
    "optimizer.type_guided_min_support": "type_guided_min_support",
    "optimizer.type_guided_max_leaf_groups": "type_guided_max_leaf_groups",
    "optimizer.type_guided_tree_depth": "type_guided_tree_depth",
    "optimizer.type_guided_tree_builder": "type_guided_tree_builder",
    "optimizer.type_guided_max_tree_depth": "type_guided_max_tree_depth",
    "optimizer.type_guided_merge_target_children": "type_guided_merge_target_children",
    "optimizer.type_guided_merge_max_children": "type_guided_merge_max_children",
    "optimizer.type_guided_merge_strategy": "type_guided_merge_strategy",
    "optimizer.type_guided_grouping_mode": "type_guided_grouping_mode",
    "optimizer.type_guided_grouping_seed": "type_guided_grouping_seed",
    "optimizer.type_guided_top_mode": "type_guided_top_mode",
    "optimizer.type_guided_fallback_enabled": "type_guided_fallback_enabled",
    "optimizer.type_guided_fallback_max_hops": "type_guided_fallback_max_hops",
    "optimizer.type_guided_fallback_allow_leaf": "type_guided_fallback_allow_leaf",
    "optimizer.type_guided_leaf_fallback": "type_guided_leaf_fallback",
    "optimizer.type_guided_rollout_repeats": "type_guided_rollout_repeats",
    "optimizer.type_guided_tau_succ": "type_guided_tau_succ",
    "optimizer.type_guided_max_patch_records": "type_guided_max_patch_records",
    "optimizer.type_guided_fallback_eval_all_leaves": "type_guided_fallback_eval_all_leaves",
    "optimizer.type_guided_fallback_top_k": "type_guided_fallback_top_k",
    "optimizer.type_guided_fallback_tau_child": "type_guided_fallback_tau_child",
    "optimizer.type_guided_fallback_min_leaf_coverage": "type_guided_fallback_min_leaf_coverage",
    "optimizer.type_guided_validation_budget": "type_guided_validation_budget",
    "optimizer.type_guided_fallback_sel_env_num": "type_guided_fallback_sel_env_num",
    "optimizer.type_guided_fallback_reconcile": "type_guided_fallback_reconcile",
    "optimizer.type_guided_fallback_reconcile_min_children": "type_guided_fallback_reconcile_min_children",
    "optimizer.type_guided_cache_dir": "type_guided_cache_dir",
    "optimizer.type_guided_patch_record_workers": "type_guided_patch_record_workers",
    "optimizer.type_guided_clustering": "type_guided_clustering",
    "optimizer.type_guided_cluster_target_size": "type_guided_cluster_target_size",
    "optimizer.type_guided_cluster_max_size": "type_guided_cluster_max_size",
    "optimizer.type_guided_tail_bank": "type_guided_tail_bank",
    "optimizer.type_guided_tail_min_support": "type_guided_tail_min_support",
    "optimizer.type_guided_tail_max_records": "type_guided_tail_max_records",
    "optimizer.type_guided_tail_max_leaf_groups": "type_guided_tail_max_leaf_groups",
    "optimizer.type_guided_tail_window_epochs": "type_guided_tail_window_epochs",
    "optimizer.type_guided_tail_require_cross_step": "type_guided_tail_require_cross_step",
    "optimizer.type_guided_leaf_merge_workers": "type_guided_leaf_merge_workers",
    "optimizer.type_guided_mid_merge_workers": "type_guided_mid_merge_workers",
...
def _load_yaml(path: str, _visited: set[str] | None = None) -> dict:
    ...
    # YAML parses a section written as ``gradient:`` (with no children) as
    # ``None``.  In a structured child config that should mean "no overrides
    # for this section", not "replace the inherited mapping with null".
    # Normalising here preserves base defaults and also makes subsequent CLI
    # dotted-key overrides safe.
    ...
    for item in overrides:
        ...
        if "." in key:
            ...
            if section_value is None:
                ...
                raise TypeError(
                    f"Cannot apply override {item!r}: config section "
                    f"{section!r} must be a mapping, got "
                    f"{type(section_value).__name__}"
                )
            section_value[subkey] = val
        else:
